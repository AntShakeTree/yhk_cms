...
public class Session {
    ...
    public static <V> V setCache(Object key, V value, long time,
                                 TimeUnit timeUnit) {
    ...
    public static <T> T getCache(Object queryUtil,Class<T> tClass) {
        return (T) session.get(queryUtil);
    }
...
//	}
    ...
    public static void removeCacheByOrigin(Object key) {
        session.remove(key);
    }
