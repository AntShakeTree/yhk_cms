...
public class PreTrailPassCode implements java.io.Serializable {
     ...
     * default constructor
     */
    public PreTrailPassCode() {
    }

    /**
     * minimal constructor
     */
    public PreTrailPassCode(Date cycleTime) {
     ...
     * full constructor
     */
    public PreTrailPassCode(String passCode, Integer length, Boolean useFlag,
